...
public class Utils {
	...
	public static TidList intersectAll(List<PlainTransaction> transactions) {
		...
		//System.out.println("TidList - Before Intersect = " + transactions);
		//System.out.println("TidList - After Intersect = " + intersection);
		//System.out.print("  avec une intersection = " + intersection+" ");
		return intersection;
	}
